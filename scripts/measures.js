...
let wskaznik = function (evt) {
  ...
  if (!document.getElementById("measureCheckbox").checked) {
    //Jeżeli checkbox "Mierz" nie jest zaznaczony
    return;
  } else {
...
function ClearMeasurements() {
  vector_layer
    .getSource()
    .getFeatures()
    .forEach((feature) => vector_layer.getSource().removeFeature(feature));
